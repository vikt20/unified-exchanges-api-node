...
export function isBitgetAlgoOrder(value) {
    return isRecord(value)
...
export function isBitgetPendingAlgoOrders(value) {
    return isRecord(value);
}
...
export function convertAlgoOrder(item) {
    ...
    const orderStatus = normalizedStatus === 'executed'
        ? 'FINISHED'
