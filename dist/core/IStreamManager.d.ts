 ...
 */
import type { KlineData, DepthData, BookTickerData, TradeData, FundingData, FundingStreamOptions, UserData, HandleWebSocket, SocketStatus, IWebsocketApiClient } from './types.js';
/**
